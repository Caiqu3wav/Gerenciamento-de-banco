...
public class Pin extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (!npin.equals(rpin)) {
                JOptionPane.showMessageDialog(null, "PIN Inserido é incorreto");
                return;
            }

            if (ae.getSource() == b1) {
                if (t1.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Insira o novo PIN");
                }
                if (t2.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Escreva outro PIN");
                }
